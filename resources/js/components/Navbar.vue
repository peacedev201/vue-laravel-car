    ...
    <div class="container-fluid" style="background: black;">
      ...
      <div id="navbarToggler" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <template v-else>
            <li class="nav-item">
              <router-link :to="{ name: 'login' }" class="nav-link" style="color: white;" active-class="active">
                {{ $t('login') }}
              </router-link>
            </li>
            <li class="nav-item">
              <router-link :to="{ name: 'register' }" class="nav-link" style="color: white;" active-class="active">
                {{ $t('register') }}
              </router-link>
            </li>
          </template>
