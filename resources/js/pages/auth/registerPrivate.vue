<template>
  <div class="row mobile-registerPrivate-view" style="margin: 0;">
      ...
      <card v-else :title="$t('REGISTER AS A PRIVATE USER')">
        <form @submit.prevent="register" @keydown="form.onKeydown($event)">
         ...
         <div class="form-group row">
            ...
            <div class="col-md-7">
              <input v-model="form.idNumber" :class="{ 'is-invalid': form.errors.has('idNumber') }" class="form-control" type="number" name="idNumber">
              <has-error :form="form" field="idNumber" />
            </div>
          </div>

          <!-- Name -->
          <div class="form-group row">
            <label class="col-md-3 col-form-label text-md-right">{{ $t('Full Name') }}</label>
            <div class="col-md-7">
